 ...
 */
final class Version20210401113701 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE document ALTER type_id DROP NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE document ALTER type_id SET NOT NULL');
    }
}
